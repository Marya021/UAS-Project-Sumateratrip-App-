								...
								<div class="row">
									...
									<div class="col-lg-8">
										<div class="offers_content">
											...
											<p class="offers_text">From : <?= $f['from'] ?></p>
											<p class="offers_text">To : <?= $f['to'] ?></p>
											<p class="offers_text">Leave : <?= $f['leave'] ?></p>
											<p class="offers_text">Arrived: <?= $f['arrived'] ?></p>
											<p class="offers_text">Price: <?= $f['price'] ?></p>

											<?php echo anchor('beranda/flights_my_book/'.$f['id_trans'],'<div class="btn btn-xd btn-primary">Book</div>'); ?>
