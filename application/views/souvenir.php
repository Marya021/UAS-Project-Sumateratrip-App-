								...
								<div class="row">
									...
									<div class="col-lg-8">
										<div class="offers_content">
											...
											<p class="offers_text">Location : <?= $f['location'] ?></p>
											<p class="offers_text">Info: <?= $f['info'] ?></p>
											<p class="offers_text">Address: <?= $f['address'] ?></p>

											<?php echo anchor('beranda/add_my_book/'.$f['id_souv'],'<div class="btn btn-xd btn-primary">Book</div>'); ?>
