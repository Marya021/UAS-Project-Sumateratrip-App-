                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <div class="input-group input-group-merge">
                                ...
                                <input class="form-control" type="text" name="name" placeholder="Car">
                              </div>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                              <div class="input-group input-group-merge">
                                ...
                                <input class="form-control" type="text" name="from" placeholder="Location">
                              </div>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <span class="input-group-text"></span>
                                ...
                                <textarea class="form-control" type="text" name="ket" placeholder="Detail"></textarea>
                              </div>
