                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <div class="input-group input-group-merge">
                                ...
                                <input class="form-control" type="text" name="name" placeholder="Trains">
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <div class="input-group input-group-merge">
                                ...
                                <input class="form-control" type="date" name="leave" placeholder="Departure">
                              </div>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                              <div class="input-group input-group-merge">
                                ...
                                <input class="form-control" type="text" name="from" placeholder="Origin">
                              </div>
                          ...
                          <div class="col-md-6">
                                <div class="form-group">
                                  <div class="input-group input-group-merge">
                                    ...
                                    <input class="form-control" type="date" name="arrived" placeholder="Return">
                                  </div>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                              <div class="input-group input-group-merge">
                                ...
                                <input class="form-control" type="text" name="to" placeholder="Destination">
                              </div>
