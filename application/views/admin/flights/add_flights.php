                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <div class="input-group input-group-merge">
                                ...
                                <input class="form-control" type="text" name="name" placeholder="Airline">
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <div class="input-group input-group-merge">
                                ...
                                <input class="form-control" type="time" name="leave" placeholder="Leave">
                              </div>
                          ...
                          <div class="col-md-6">
                                <div class="form-group">
                                  <div class="input-group input-group-merge">
                                    ...
                                    <input class="form-control" type="time" name="arrived" placeholder="Arrived">
                                  </div>
