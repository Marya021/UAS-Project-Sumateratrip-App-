	...
	<div class="super_container">
		...
		<div class="home">
			...
			<div class="home_content">
				<div class="home_title">Our ACCOMMODATIONS</div>
			</div>
		</div>
		...
		<div class="offers">
								...
								<div class="search_tabs_container">
									<div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
										<div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start">
											<a href="<?= base_url(); ?>beranda/acco" style="color:#2d2c2c;"><img src="<?= base_url(); ?>layout/images/suitcase.png" alt="">HOTEL</a>
										</div>
								...
								<div class="search_panel active">
									<form action="#" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
										<div class="search_item">
											...
											<div><br>Guest and Room</div>
											<select name="adults" id="adults_2" class="dropdown_item_select search_input">
												<option>1 guest, 1 rooms</option>
												<option>2 guest, 1 rooms</option>
												<option>3 guest, 1 rooms</option>
											</select>
										</div>
										<div class="search_item">
											<div>Check in</div>
			...
			<div class="container">
				<div class="row"> 
					<?php foreach($accommodations as $f): ?>
								...
								<div class="row">
									...
									<div class="col-lg-8">
										<div class="offers_content">
											...
											<p class="offers_text">Spesification : <?= $f['ket'] ?></p>
											<p class="offers_text">Rating : Bintang <?= $f['rating'] ?></p>
											<p class="offers_text">Address: <?= $f['address'] ?></p>
											<p class="offers_text">Price: <?= $f['price'] ?></p>

											<?php echo anchor('beranda/add_my_book/'.$f['id_hotels'],'<div class="btn btn-xd btn-primary">Book</div>'); ?>
